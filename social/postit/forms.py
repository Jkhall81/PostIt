...
class ProfilePicForm(forms.ModelForm):
    ...
    homepage_link = forms.CharField(label='Homepage Link', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Homepage Link'}))
    facebook_link = forms.CharField(label='Facebook Link', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Facebook Link'}))
    instagram_link = forms.CharField(label='Instagram Link', widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Instagram Link'}))
    linkedin_link = forms.CharField(label='Linkedin Link', widget=forms.TextInput(
